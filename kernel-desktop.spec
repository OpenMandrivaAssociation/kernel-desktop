...
%define uname_r		3.2.0-1.1-desktop%{nil}

%define source_release	1
%define build_release	1%{nil}

%define archive		kernel-desktop-3.2-1.1
...
Source1:		3.2.0-1.1-desktop-x86_32-defconfig
Source2:		3.2.0-1.1-desktop-x86-develfiles.list
Source3:		3.2.0-1.1-desktop-x86_64-defconfig
Source4:		3.2.0-1.1-desktop-develfiles.list
Source5:		3.2.0-1.1-desktop-output-develfiles.list
...
%changelog
* Thu Jan 12 2012 Franck Bui <franck.bui@mandriva.com> 3.2.0-1.1-desktop
