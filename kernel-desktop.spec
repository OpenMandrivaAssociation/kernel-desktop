...
%define uname_r		3.2.7-1.2-desktop%{nil}
%define source_release	1
%define build_release	2%{nil}
%define archive		kernel-desktop-3.2.7-1.2
...
Source1:		3.2.7-1.2-desktop-x86_32-defconfig
Source2:		3.2.7-1.2-desktop-x86-develfiles.list
Source3:		3.2.7-1.2-desktop-x86_64-defconfig
Source4:		3.2.7-1.2-desktop-develfiles.list
Source5:		3.2.7-1.2-desktop-output-develfiles.list
...
%changelog
* Mon Feb 27 2012 Franck Bui <franck.bui@mandriva.com> 3.2.7-1.2-desktop
