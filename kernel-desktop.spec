...
Source:        kernel-2.6.39.1-1.2-desktop.tar.bz2
...
Summary:       The Linux Kernel for Mandriva systems
Provides:      kernel = 2.6.39.1.1.2
Provides:      kernel-desktop = 2.6.39.1.1.2
...
Provides:      kernel-devel = 2.6.39.1.1.2
Provides:      kernel-desktop-devel = 2.6.39.1.1.2
BuildRequires: rsync
...
Provides:      kernel-debuginfo = 2.6.39.1.1.2
Provides:      kernel-desktop-debuginfo = 2.6.39.1.1.2
...
%prep
%setup -q -n 2.6.39.1-1.2-desktop

%build
make defconfig
make -s kernelrelease
test $(make -s kernelrelease) = 2.6.39.1-1.2-desktop
make %{?_smp_mflags}
...
cp %{bzImage} %{buildroot}/boot/vmlinuz-2.6.39.1-1.2-desktop
cp System.map %{buildroot}/boot/System.map-2.6.39.1-1.2-desktop
cp .config    %{buildroot}/boot/config-2.6.39.1-1.2-desktop
ln -snf /usr/src/devel/2.6.39.1-1.2-desktop %{buildroot}/lib/modules/2.6.39.1-1.2-desktop/build
ln -snf build %{buildroot}/lib/modules/2.6.39.1-1.2-desktop/source

mkdir -p %{buildroot}/usr/src/devel/2.6.39.1-1.2-desktop
cat develfiles-%asmarch.list >>develfiles.list
rsync -ar --files-from=develfiles.list . %{buildroot}/usr/src/devel/2.6.39.1-1.2-desktop

%post -n kernel-desktop
/sbin/installkernel 2.6.39.1-1.2-desktop

%preun -n kernel-desktop
/sbin/installkernel -R 2.6.39.1-1.2-desktop

%postun -n kernel-desktop
/sbin/kernel_remove_initrd 2.6.39.1-1.2-desktop
...
%defattr (-, root, root)
%dir /lib/modules
/lib/modules/2.6.39.1-1.2-desktop
/boot

%files -n kernel-desktop-devel
%defattr (-, root, root)
/usr/src/devel/2.6.39.1-1.2-desktop

%files -n kernel-desktop-debuginfo -f debugfiles.list
%defattr (-, root, root)

%changelog
* Tue Jul 26 2011 Franck Bui <franck.bui@mandriva.com> 2.6.39.1-1.2-desktop
