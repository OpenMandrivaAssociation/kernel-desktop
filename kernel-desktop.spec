#
# Spec file generated by kdist version v0.0.4-40-g64d2-dirty
#
Name:          kernel-desktop
...
Source:        kernel-desktop-3.1.0-rc7-1.tar.bz2
...
Summary:       The Linux Kernel for Mandriva systems
Provides:      kernel = 3.1.0.rc7.1.1
Provides:      kernel-desktop = 3.1.0.rc7.1.1
...
Provides:      kernel-devel = 3.1.0.rc7.1.1
Provides:      kernel-desktop-devel = 3.1.0.rc7.1.1
...
Provides:      kernel-debuginfo = 3.1.0.rc7.1.1
Provides:      kernel-desktop-debuginfo = 3.1.0.rc7.1.1
...
%prep
%setup -q -n kernel-desktop-3.1.0-rc7-1

%build
make defconfig
make -s kernelrelease
test $(make -s kernelrelease) = 3.1.0-rc7-1.1-desktop
make %{?_smp_mflags}
...
cp %{bzImage} %{buildroot}/boot/vmlinuz-3.1.0-rc7-1.1-desktop
cp System.map %{buildroot}/boot/System.map-3.1.0-rc7-1.1-desktop
cp .config    %{buildroot}/boot/config-3.1.0-rc7-1.1-desktop
ln -snf /usr/src/devel/3.1.0-rc7-1.1-desktop %{buildroot}/lib/modules/3.1.0-rc7-1.1-desktop/build
ln -snf build %{buildroot}/lib/modules/3.1.0-rc7-1.1-desktop/source

mkdir -p %{buildroot}/usr/src/devel/3.1.0-rc7-1.1-desktop
cat develfiles-%asmarch.list >>develfiles.list
rsync -ar --files-from=develfiles.list . %{buildroot}/usr/src/devel/3.1.0-rc7-1.1-desktop

%post -n kernel-desktop
/sbin/installkernel 3.1.0-rc7-1.1-desktop

%preun -n kernel-desktop
/sbin/installkernel -R 3.1.0-rc7-1.1-desktop

%postun -n kernel-desktop
/sbin/kernel_remove_initrd 3.1.0-rc7-1.1-desktop
...
%defattr (-, root, root)
%dir /lib/modules
/lib/modules/3.1.0-rc7-1.1-desktop
/boot

%files -n kernel-desktop-devel
%defattr (-, root, root)
/usr/src/devel/3.1.0-rc7-1.1-desktop

%files -n kernel-desktop-debuginfo -f debugfiles.list
%defattr (-, root, root)

%changelog
* Thu Sep 22 2011 Franck Bui <franck.bui@mandriva.com> 3.1.0-rc7-1.1-desktop
  + Mandriva Release v3.1-rc7-1
  + drm/i915: FBC off for ironlake, otherwise on by default
