#
# Spec file generated by kdist version v0.0.4-164-gbc4a
#
%define name		kernel-desktop
%define version		3.1.4

%define src_uname_r	3.1.4-1
%define uname_r		3.1.4-1.0-desktop%{nil}

%define source_release	1
%define build_release	0%{nil}

%define archive		kernel-desktop-3.1.4-1.0
...
Source1:		3.1.4-1.0-desktop-x86_64-defconfig
Source2:		3.1.4-1.0-desktop-x86-develfiles.list
Source3:		3.1.4-1.0-desktop-develfiles.list
Source4:		3.1.4-1.0-desktop-generated-develfiles.list
...
%description -n %{name}
This %{name} is for testing purpose only
...
%if %build_devel
%post -n %{name}-devel
make -s -C %{kdevel_path} modules_prepare
%endif
...
%changelog
* Thu Dec 15 2011 Franck Bui <franck.bui@mandriva.com> 3.1.4-1.0-desktop
